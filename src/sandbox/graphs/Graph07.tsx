...
const Graph07 = () => {
  return (
    <div className="h-80">
      <h3 className="text-lg font-semibold text-[#E8E2F4] mb-2">07 - Points Emphasis</h3>
      <p className="text-sm text-[#6B6483] mb-2">Large points, thin connecting lines</p>
      <div className="h-64">
        <ResponsiveLine
          ...
          theme={{
            background: '#1E1A2E',
            text: { fill: '#A9A1C1' },
            grid: { line: { stroke: '#3D3554', strokeDasharray: '4 4' } },
            axis: {
