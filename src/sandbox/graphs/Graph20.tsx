...
const Graph20 = () => {
  return (
    <div className="h-80">
      <h3 className="text-lg font-semibold text-[#E8E2F4] mb-2">20 - Triple Line</h3>
      <p className="text-sm text-[#6B6483] mb-2">Three datasets: loan, investment, and net worth</p>
      <div className="h-64">
        <ResponsiveLine
