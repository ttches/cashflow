    ...
    <div className="min-h-screen bg-[#1E1E3F]">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-[#A599E9]">
            Invest vs Pay Off Debt
          </h1>
          <p className="text-[#A599E9] mt-2">
        ...
        <div className="mb-8">
          <label className="block text-sm font-medium text-[#A599E9] mb-2">
          ...
          <input
            ...
            className="w-full max-w-md accent-[#FAD000]"
          />
        </div>
